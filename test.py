...
page = st.sidebar.radio("Sélectionnez une page :", ["Introduction du projet", "Pre-processing", "Datavisualisation","Prédiction"])

# Liste des contributeurs
st.sidebar.markdown("## Contributeurs:")
st.sidebar.write("Yasmine Kouyaté")
st.sidebar.write("Jean-Michel Deblaise")
st.sidebar.write("Youcef Arim")
st.sidebar.write("Théo Delafontaine")
...
#PARTIE CENTRALE
if page == "Introduction du projet":
    # Image de garde
    st.image("glacierfondu.jpg", use_column_width=True)
    ...
    st.markdown('<hr style="border: 2px solid #27DCE0">', unsafe_allow_html=True)
    ...
    st.markdown('<hr style="border: none; border-top: 2px solid #27DCE0; width: 50%;">', unsafe_allow_html=True)
    ...
    st.write("   Notre variable cible, si l’on se réfère au premier dataset, sera l’année 2024 (nouvelle variable/colonne dans notre tableau) ou l’algorithme essayera d’anticiper les anomalies de températures qui pourraient subvenir, en attendant les réelles mesures qui seront prises durant cette année")
    st.markdown('<hr style="border: none; border-top: 2px solid #27DCE0; width: 50%;">', unsafe_allow_html=True)
    ...
    data_temp = pd.read_csv("anomalie_temperature_globale.csv", sep=",", encoding='cp1252')
    ...
    data_co2 = pd.read_csv("co2_global_non_nettoye.csv", sep=",", encoding='cp1252')
    ...
    # Ajoutez le code pour la deuxième page ici
    pass
elif page == "Page 3":
    # Ajoutez le code pour la troisième page ici
    pass
